...
<Step subtitle="What does it even mean? 🤷🏻‍♂️">
  <Code
    code={require('!!raw-loader!../Toggle.test.js').default}
    focus="10"
    lang="jsx"
...
## Can't we do it using Enzyme?

- Yes, we can! Use `mount` instead of `shallow`
- Enzyme's API is too powerful ➡ Easy to make mistakes
- React Testing Library's API is intentionally powerless
