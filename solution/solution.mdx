...
| Demos  | End User 🙋🏻‍♂️ | Developer 👨🏻‍💻 | Test User 🧪 |
| ------ | :---------: | :----------: | :----------: |
| Demo 1 |     🆗      |      🆗      |      ❌      |
| Demo 2 |     🆗      |      🆗      |      ❌      |
| Demo 3 |     😡      |      🆗      |      ✅      |

⚠️ Test Users ≠ End Users
...
<CodeSurferLayout>
  ...
  />
  <Code
    code={require('!!raw-loader!./ToggleHooks.test.1.js').default}
    focus="2[10:15],7"
    lang="jsx"
    title="Test Toggle using React Testing Library"
  ...
  />
  <Code
    code={require('!!raw-loader!./ToggleHooks.test.2.js').default}
    focus="7[13:21],9"
    lang="jsx"
    title="Test Toggle using React Testing Library"
  ...
  />
  <Code
    code={require('!!raw-loader!./ToggleHooks.test.3.js').default}
    focus="7[24:34],10"
    lang="jsx"
    title="Test Toggle using React Testing Library"
  ...
  />
  <Code
    code={require('!!raw-loader!./ToggleHooks.test.4.js').default}
    focus="12[21:39]"
    lang="jsx"
    title="Test Toggle using React Testing Library"
  ...
  />
  <Code
    code={require('!!raw-loader!./ToggleHooks.test.5.js').default}
    focus="14:15"
    lang="jsx"
    title="Test Toggle using React Testing Library"
...
# React Testing Library Demo Recap
